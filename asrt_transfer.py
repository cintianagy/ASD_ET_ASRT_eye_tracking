...
#                  <2023>  <Orsolya Pesthy>  <pesthy.orsolya@gmail.com>
...
class Experiment:
    ...
    def __init__(self, workdir_path, project_ET_zero=True):
        ...
        self.colors = None
        # pressed button -> stimulus number mapping (e.g. {'z': 1, 'c' : 2, 'b' : 3, 'm' : 4}
        ...
        self.mywindow = None
        self.mymonitor = None
        # average time of displaying one frame on the screen in ms (e.g. 15.93 for 50 Hz)
    ...
    def all_settings_def(self):
        ...
        # if there is no settings file, we ask the user to specfiy the settings
            ...
            # get monitor / computer settings, and also options about displaying (stimulus size, stimulus distance, etc)
    ...
    def wait_for_eye_response(self, expected_eye_pos_list, fixation_threshold):
        ...
        while (True):
            ...
            with self.shared_data_lock:
                ...
                # Do we have enough data for a fixation?
                if count < fixation_threshold:
                    continue
